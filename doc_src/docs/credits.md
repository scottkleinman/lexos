...
- The <a href="http://lexos.wheatoncollege.edu/" target="blank">Lexos web app</a>, developed previously with support from the <a href="https://www.neh.gov/" target="_blank">National Endowment for the Humanities</a>
- <a href="https://spacy.io/" target="blank">spaCy</a>
- <a href="https://textacy.readthedocs.io/en/latest/index.html" target="blank">Textacy</a>
...
The `dfr_browser2` module was developed as a separate application, <a href="https://github.com/scottkleinman/dfr-browser2" target="_blank">DFR Browser 2</a>, and derives from Andrew Goldstone's <a href="https://github.com/agoldst/dfr-browser" target="_blank">dfr-browser</a>.
